import{i as e,a as t}from"./CZ-fEcpL.js";import{x as i}from"./DIFfro1Y.js";import{n as o,r as a}from"./Dh1RFCXV.js";import{c as r,o as s,U as n}from"./Bo4hXIgg.js";import{w as c,p as l,s as w,l as d,M as u,m as p,R as m,r as h,n as v,e as g,k as f,g as b,c as y,h as x,o as k,E as C,O as S,C as R,q as N,i as O,A as T,T as A,t as W,a as $,f as E}from"./Nr2JhA5Z.js";import"./DWIhupk8.js";const P=l({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),I=c({state:P,subscribe:e=>d(P,(()=>e(P))),subscribeKey:(e,t)=>w(P,e,t),showTooltip({message:e,triggerRect:t,variant:i}){P.open=!0,P.message=e,P.triggerRect=t,P.variant=i},hide(){P.open=!1,P.message="",P.triggerRect={width:0,height:0,top:0,left:0}}}),j={isUnsupportedChainView:()=>"UnsupportedChain"===m.state.view||"SwitchNetwork"===m.state.view&&m.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void u.shake();await p.isSIWXCloseDisabled()?u.shake():u.close()}},D=e`
  :host {
    display: block;
